...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sid-dev-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12194&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sid-dev-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sid-dev` can be installed with:

```
conda install sid-dev
```

It is possible to list all of the versions of `sid-dev` available on your platform with:
